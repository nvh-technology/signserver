                        ...
                        @foreach ($owners as $owner)
                            <div class="form-check mb-2">
                                <input class="form-check-input owner-checkbox" type="checkbox" name="owners[]"
                                    ...
                                    {{ in_array($owner->id, old('owners', [])) ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="owner_{{ $owner->id }}">
                                    {{ $owner->name }}
                                </label>
                            </div>
                            <div class="owner-pivot-fields card card-body bg-light mb-3"
                                id="pivot_fields_{{ $owner->id }}"
                                style="display: {{ in_array($owner->id, old('owners', [])) ? 'block' : 'none' }};">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        value="{{ old('owner_pivot.' . $owner->id . '.userName') }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        value="{{ old('owner_pivot.' . $owner->id . '.passcode') }}">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        value="{{ old('owner_pivot.' . $owner->id . '.credentialID') }}">
                                </div>
                            </div>
                        @endforeach
                    </div>
